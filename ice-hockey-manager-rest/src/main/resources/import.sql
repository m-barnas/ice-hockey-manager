...
INSERT INTO HOCKEYPLAYER (ID, ATTACKSKILL, DEFENSESKILL, NAME, POST, PRICE, TEAMID) VALUES (1,2,50,'Marek Čiliak','G',1200,1);
-- create goalie for Sparta
INSERT INTO HOCKEYPLAYER (ID, ATTACKSKILL, DEFENSESKILL, NAME, POST, PRICE, TEAMID) VALUES (2,2,50,'FILIP NOVOTNÝ','G',1200,2);
